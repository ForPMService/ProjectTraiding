...
{
    /// <summary>
    /// Работник чтения потока изменения справочника со стороны витрины.
    /// Владеет именем группы потребителей «vitrine» в потоке catalog:changed.
    /// Умеет только техническое: создать группу при необходимости, забрать новые
    /// записи и подтвердить их разбор. Про кеш и справочник ничего не знает.
    /// </summary>
    public sealed class CatalogEventReader
    {
        ...
        private readonly ILogger<CatalogEventReader> _logger;
